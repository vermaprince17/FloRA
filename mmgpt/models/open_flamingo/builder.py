...
def create_model_and_transforms(
    ...
    **flamingo_kwargs,
    ...
    text_tokenizer = AutoTokenizer.from_pretrained(tokenizer_path) #LlamaTokenizer.from_pretrained(tokenizer_path)
    ...
    #print("init llama")
    print("init LM")
    lang_encoder = AutoModelForCausalLM.from_pretrained(lang_encoder_path) #LlamaForCausalLM.from_pretrained(lang_encoder_path)
